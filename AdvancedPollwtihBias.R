...
#Code: Simulated data with  Xj=d+ϵj 
J <- 6
N <- 2000
d <- .021
p <- (d+1)/2
X <- d + rnorm(J, 0, 2*sqrt(p*(1-p)/N))
#Code: Simulated data with  Xi,j=d+ϵi,j 
I <- 5
J <- 6
N <- 2000
d <- .021
...
#Code: Simulated data with  Xi,j=d+hi+ϵi,j 
I <- 5
J <- 6
N <- 2000
d <- .021
...
#Note that sigma now includes an estimate of the variability due to general bias  σb=.025 .
